...
1. Подключите кошелёк к сети из `addresses.json`.
...
5. **Тесты** — при необходимости проверяйте пруфы или пользуйтесь Shamir.
